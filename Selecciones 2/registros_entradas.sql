...
--1
select * from registros_entradas where (to_char(fecha, 'MM') = '09') or (cedula_empleado like '17%');
--2
select * from registros_entradas where (to_char(fecha, 'MM') = '08') and (cedula_empleado like '17%') and (hora between '08:00' and '12:00');
--3
select * from registros_entradas where ((to_char(fecha, 'MM') = '08') and (cedula_empleado like '17%') and (hora between '08:00' and '12:00')) or ((to_char(fecha, 'MM') =  '09') and (cedula_empleado like '08%') and (hora between '09:00' and '13:00'));